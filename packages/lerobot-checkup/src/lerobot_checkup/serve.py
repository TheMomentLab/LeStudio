"""Helpers shared by the ``lerobot-checkup serve`` and ``lestudio serve`` commands."""
...
def resolve_config_dir(config_dir_arg: Path | None) -> Path:
    """Config directory shared by lerobot-checkup and LeStudio (device mappings, camera settings)."""
