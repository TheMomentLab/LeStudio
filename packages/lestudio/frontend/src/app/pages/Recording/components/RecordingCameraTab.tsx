...
import { Card, FieldRow, WireSelect, EmptyState } from "../../../components/wireframe";
...
export function RecordingCameraTab({
  ...
  return (
    <div className="flex flex-col gap-4">
            <Card title="Camera Feeds" bodyClassName="flex flex-col gap-3">
        {camerasMapped.length === 0 ? (
          <EmptyState
            icon={<Camera size={28} />}
            message={(
              <>
                No camera mappings. First connect cameras in the <a href="/camera-setup" className="underline hover:text-fg-body transition-colors">Camera Setup</a> tab.
              </>
            )}
