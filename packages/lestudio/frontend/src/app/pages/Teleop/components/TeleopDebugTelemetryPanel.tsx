import { Card, SectionLabel } from "../../../components/wireframe";
import {
  formatDebugNumber,
  formatJointName,
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-3">
        <div className="rounded border border-line bg-surface-muted p-3">
          ...
          <div className="mt-2 text-sm text-fg-body flex flex-col gap-1">
        ...
        <div className="rounded border border-line bg-surface-muted p-3">
          ...
          <div className="mt-2 text-sm text-fg-body flex flex-col gap-1 font-mono">
      ...
      {debugSnapshot ? (
        <>
            ...
            <table className="min-w-full text-sm font-mono">
              ...
              <tbody>
                {debugJointRows.map((row) => (
                  <tr key={row.key} className="border-t border-line text-fg-body">
          ...
          <div className="rounded border border-line bg-surface-sunken text-fg-body p-3 overflow-x-auto">
        ...
        <div className="rounded border border-dashed border-line-strong px-4 py-6 text-sm text-fg-muted">
