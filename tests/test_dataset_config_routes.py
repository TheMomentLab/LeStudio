"""Behavioral tests for dataset listing and config routes."""
...
from lerobot_checkup.routes.models import CameraSettingsRequest
...
def test_api_camera_settings_save_and_get(tmp_path: Path, monkeypatch):
    ...
    monkeypatch.setattr("lerobot_checkup._streaming.restart_all_streamers", lambda config_path: None)
